...
public class RecipeScale {
	...
	/**
	 * Constructs a recipeScale object
	 */
	public RecipeScale() {
		test = false;
	}
	 ...
	 * @param x The X part of the desired test resolution
	 * @param y The Y part of the desired test resolution
	 */
	...
	/**
	 * Scales a Recipe to user screen size
	 * @param recipe The recipe that all elements need to be scaled for.
	 * @return recipe The scaled recipe
	 */
