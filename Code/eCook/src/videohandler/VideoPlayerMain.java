...
public class VideoPlayerMain extends Application {
    ...
    public void start(final Stage primaryStage) {
        ...
        VideoPlayerHandler videoPlayerHandler = new VideoPlayerHandler(parent,"http://download.oracle.com/otndocs/products/javafx/oow2010-2.flv", 300, 300, 300, 400, true, null, 5);
