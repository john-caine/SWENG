	            ...
	            public void handle(ActionEvent e) {
	                ...
	                slideIn.getKeyFrames().addAll(
	                        new KeyFrame(Duration.ZERO,
	                                new KeyValue(hbox.translateYProperty(), bounds.getHeight()),
	                                new KeyValue(hbox.opacityProperty(), 0.0)
	                                ),
	                        new KeyFrame(new Duration(100),
	                                new KeyValue(hbox.translateYProperty(), bounds.getHeight()-120),
	                                new KeyValue(hbox.opacityProperty(), 0.9)
	                                )
	                );
